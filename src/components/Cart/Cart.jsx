      ...
      {cart.length > 0 ? (
        ...
        <>
          ...
          >
            ...
            <DialogBody divider>
              <div>
                <h1 className="text-black text-3xl font-inter font-bold tracking-normal leading-non py-4">
                  Your bag is empty
                </h1>
                <p className="text-black text-base font-inter tracking-normal leading-non">
                  Add some products
                </p>
              </div>
            </DialogBody>
